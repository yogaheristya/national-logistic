            ...
            <div class="card-box">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data" name="release_do" id="release_do" role="form" data-parsley-validate novalidate>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group row">
                            ...
                            if ($data_header['filepath_requestor'] != "") { ?>
                                <div class="col-md-0" style="display: flex;align-self: center;">
                                    <a href="https://apps1.insw.go.id/upload/meta_requestor/<?= $data_header['filepath_requestor'] ?>" target="_blank" class="btn btn-info btn-sm" role="button">Show File</a>
                        ...
                        <div class="form-group row">
                            ...
                            if ($data_header['filepath_bl'] != "") { ?>
                                <div class="col-md-0" style="display: flex;align-self: center;">
                                    <a href="https://apps1.insw.go.id/upload/meta_bl/<?= $data_header['filepath_bl'] ?>" target="_blank" class="btn btn-info btn-sm" role="button">Show File</a>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="callsign" required parsley-type="text" class="form-control" id="callsign" placeholder="Please insert callsign" maxlength="10" value="<?= $data_header["callsign"] ? $data_header["callsign"] : '' ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control select2" name="terminal" placeholder="Please Select" onchange="cek_pin()" id="terminal" required>
                                    <option value=""> - </option>
                                    <option value="BICT">BICT - BELAWAN INTERNATIONAL CONTAINER TERMINAL</option>
                                    <option value="CDP">CDP - CIKARANG DRY PORT</option>
                                    <option value="IKT">IKT - INDONESIA KENDARAAN TERMINAL</option>
                                    <option value="JICT">JICT - JAKARTA INTERNATIONAL CONTAINER TERMINAL</option>
                                    <option value="KOJA">KOJA - KOJA</option>
                                    <option value="PRM1">PRM1 - PT PRIMA TERMINAL PETIKEMAS</option>
                                    <option value="TEMAL">TEMAL - MUSTIKA ALAM NUSANTARA</option>
                                    <option value="TPKS">TPKS - TERMINAL PETI KEMAS SEMARANG</option>
                                    <option value="TPS">TPS - TERMINAL PETI KEMAS SURABAYA</option>
                                    <option value="TTL">TTL - TERMINAL TELUK LAMONG</option>
                                </select>
                            </div>
                    ...
                    <?php if ($data_header['cargo_type'] != 3) { ?>
                        <!--tambahan logic cargo-->
                        <div id="container-ship">
                            <fieldset class="scheduler-border">
                                                    ...
                                                    <tr class="collapse" id="row<?= $i ?>">
                                                        <td colspan="7">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input placeholder="i.e. 02131232133" id="telp_depo" name="telp_depo[]" type="text" class="form-control" data-parsley-trigger="keyup" data-parsley-type="digits" required value="<?= $container["telp_depo"] ? str_replace('-', '', $container["telp_depo"]) : '' ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered" style="text-align: center;">
                                        <thead>
                                            ...
                                            if ($data_goods != "" and !empty($data_measurement)) {
                                                $i = 0;
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        if ($payment['filepath_buktibayar'] != "") { ?>
                                            <a href="https://apps1.insw.go.id/upload/meta_buktibayar/<?= $payment['filepath_buktibayar'] ?>" target="_blank" class="btn btn-info btn-sm" role="button">Show File</a>
