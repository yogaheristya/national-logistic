        ...
        <div class="col-xl-12">
            <div class="card-box">
                <form class="form-horizontal" method="post" enctype="multipart/form-data" name="request_do" id="request_do" role="form" data-parsley-validate>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3" style="display: flex;">
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="input[status_requestor]" id="cargo" onclick="CheckRequestor();" <?= $request['status_requestor'] == "1" ? "checked" : "" ?> value="1">Cargo Owner
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="input[status_requestor]" id="freight" onclick="CheckRequestor();" <?= $request['status_requestor'] == "2" ? "checked" : "" ?> value="2">Freight Forwarder
                                    </label>
                                </div>
                            </div>
                            <?php
                            if ($request['filepath_requestor'] != "") { ?>
                                <div class="col-md-1">
                                    <a href="https://apps1.insw.go.id/upload/meta_requestor/<?= $request['filepath_requestor'] ?>" target="_blank" class="btn btn-info btn-sm" role="button">Show File</a>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="input[tglexpreqdo]" parsley-type="text" class="form-control" id="exp_date" placeholder="" value="<?= $request["tglexpdo"] ?>" required>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            if ($request['filepath_bl'] != "") { ?>
                                <div class="col-md-1">
                                    <a href="https://apps1.insw.go.id/upload/meta_bl/<?= $request['filepath_bl'] ?>" target="_blank" class="btn btn-info btn-sm" role="button">Show File</a>
                    ...
                    <input type="hidden" name="input[cargo_type]" id="select_jenis" value="<?= $request['cargo_type'] ?>">
                    <!-- container -->
                    <?php if ($request['cargo_type'] != "3") { ?>
                        <fieldset class="scheduler-border">
                                    ...
                                    <tbody id="tbody_container">
                                        ...
                                        ?>
                                            ...
                                            foreach ($container as $con) { ?>
                                                ...
                                                <input type="hidden" name="numCont[]" value="<?= $no ?>">
                                                <tr>
                                                    <td width="10%">
                                                    ...
                                                    <td>
                                                        <div id="rowSeal_<?= $no ?>">
                                                            <div class="form-group row" style="margin-bottom: 0 !important;">
                                                                <div class="col-sm-9">
                                                                    <input type="text" id="seal_no_0" name="seal_no_<?= $no ?>[]" class="form-control" data-error="This field is required" value="" placeholder="i.e SEAL123456" />
                                                                </div>
                                                                <div class="col-sm-1">
                                                                    <button class="btn btn-sm btn-success" type="button" id="addseal_0" onclick="addseal(<?= $no ?>)">+</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="numRowsChild_0" id="numRowsChild_<?= $no ?>" value="<?= $no ?>">
                                                        <?php
                                                        $nomer = 0;
                                                        foreach ($con["0"] as $seal) { ?>
                                                            <div id="rowSeal_<?= $nomer ?>" class="removeseal">
                                                                <div class="form-group row" style="margin-bottom: 0 !important;margin-top: 10px;">
                                                                    <div class="col-sm-9">
                                                                        <input type="text" id="seal_no" name="seal_no_<?= $no ?>[]" class="form-control" data-error="This field is required" placeholder="" value="<?= $seal ?>" />
                                                                    </div>
                                                                    <div class="col-sm-1">
                                                                        <button class="btn btn-sm btn-warning button_remove" type="button" id="removeseal_0">x</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <?php $nomer++; ?>
                                                    ...
                                                    <td>
                                                        <select class="form-control select2" name="size_type[]" id="size_type<?= $no ?>">
                                                            <option></option>
                                                            <?php
                                                    ...
                                                    <td>
                                                        <div class="form-group row" style="margin-bottom: 0 !important;">
                                                            <div class="col-sm-8">
                                                                <input placeholder="i.e 100.01" id="gross_weight" name="gross_weight[]" type="text" value="<?= $con["gross_weight"] ?>" class="form-control" data-parsley-trigger="keyup" data-parsley-type="number" required>
                                                            </div>
                                                            <div class="col-sm-4">
                                        ...
                                        <tbody id="tbody_non_container">
                                            ...
                                            foreach ($goods as $good) { ?>
                                                ...
                                                <tr><input type="hidden" name="numNonCont[]" value="0">
                                                    ...
                                                    <td width="10%"><textarea class="form-control" id="goods_desc" name="goods_desc[]" rows="2" spellcheck="false" placeholder="Max 1024 Characters" maxlength="1024"><?= $good['goods_desc'] ?></textarea></td>
                                                    <td>
                                                        <div class="form-group row" style="margin-bottom: 0 !important;">
                                                            <div class="col-sm-12">
                                                                <input placeholder="i.e 100" id="package_qty" name="package_qty[]" type="text" class="form-control" value="<?= $measurement[$i]["package_qty"] ?>" data-parsley-trigger="keyup" data-parsley-type="digits">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group row" style="margin-bottom: 0 !important;">
                                                            <div class="col-sm-12"><select class="form-control" name="package_satuan[]" id="package_satuan<?= $i ?>">
                                                    ...
                                                    <td>
                                                        <div class="form-group row" style="margin-bottom: 0 !important;">
                                                            <div class="col-sm-12"><input placeholder="i.e 100.01" id="gross_weight_non" name="gross_weight_non[]" type="text" class="form-control" value="<?= $measurement[$i]["gross_qty"] ?>" data-parsley-trigger="keyup" data-parsley-type="number"></div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group row" style="margin-bottom: 0 !important;">
                                                            <div class="col-sm-12"><select class="form-control" id="gross_weight_non_satuan<?= $i ?>" name="gross_weight_non_satuan[]" required aria-hidden="true">
                                                                    <option value="TNE">TNE</option>
                                                                    <option value="KGM">KGM</option>
                                                                </select></div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="form-group row" style="margin-bottom: 0 !important;">
                                                            <div class="col-sm-12"><input placeholder="i.e 100.01" id="measurement_qty" name="measurement_qty[]" type="text" class="form-control" value="<?= $measurement[$i]["measurement_qty"] ?>" data-parsley-trigger="keyup" data-parsley-type="number"></div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group row" style="margin-bottom: 0 !important;">
                                                    ...
                                                    <?php } else { ?>
                                                        <td align="center"><input type="button" class="delete_non_container btn btn-sm btn-danger" value="Delete"></td>
                                                    <?php } ?>
                                                </tr>
                                            <?php $i++;
                                            } ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    if ($pay['filepath_buktibayar'] != "") { ?>
                                        <div class="col-md-1" style="display: block;align-self: center;text-align: center;">
                                            <a href="https://apps1.insw.go.id/upload/meta_buktibayar/<?= $pay['filepath_buktibayar'] ?>" target="_blank" class="btn btn-info btn-sm" role="button">Show File</a>
                        ...
                        ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1" style="display: flex; align-self: center;">
                                        ...
                                        <input type="file" name="filepath_dok[]" id="filepath_dok" class="form-control-file" class="form-control" value="<?= $doc['filepath_dok'] ?>" />
                                    </div>
                                    <div class="col-md-1" style="display: block;align-self: center;text-align: center;">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#addrow_non").on("click", function() {
            ...
            cols2 += '<td width="10%"><textarea class="form-control" id="goods_desc" name="goods_desc[]" rows="2" spellcheck="false" placeholder="Max 1024 Characters" maxlength="1024" required></textarea></td>';
            ...
            cols2 += '<td><div class="form-group row" style="margin-bottom: 0 !important;"><div class="col-sm-12"><select class="form-control" name="package_satuan[]" required><option value="Unit">Unit</option><option value="PCE">PCE</option></select></div></div></td>';
        ...
        $(".button_remove").click(function() {
            $(this).closest(".removeseal").remove();
        });
        ...
        $("#add_document").on("click", function() {
            ...
            var cols = "";
            cols += '<div class="form-group row">';
            cols += '<label for="type" class="col-sm-1 col-form-label">Doc Type</label><div class="col-sm-2"><select class="form-control select2" name="jenis_dok[]" required><option></option><option value="4">Letter of Indemnity (LOI)</option><option value="5">Suarat Peminjaman Kontainer</option><option value="6">ID Penerima Kuasa</option><option value="10">VIN</option><option value="9">Lainnya</option></select></div>';
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        foreach ($measurement as $mea) { ?>
            $("#package_satuan<?= $i ?>").val('<?php echo $mea["package_uom"] ?>').attr('selected', true).trigger("change");
            $("#gross_weight_non_satuan<?= $i ?>").val('<?php echo $mea["gross_uom"] ?>').attr('selected', true).trigger("change");
        <?php $i++;
        } ?>
        ...
        $("#BtnEdit").click(function(e) {
            ...
            var payment = document.getElementsByName("invoice_no[]"),
                i;
