        ...
        <div class="col-xl-12">
            <div class="card-box">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data" name="extend_request" id="extend_request" role="form" data-parsley-validate novalidate>
                    ...
                    <input type="hidden" name="input[cargo_type]" id="select_jenis" value="<?= $data_header['cargo_type'] ?>">
                    <!-- Container -->
                                        ...
                                        <thead>
                                            ...
                                            if ($data_goods != "" and !empty($data_measurement)) {
                                                ...
                                                foreach ($data_goods as $goods) {
                                                    ...
                                                    <input type="hidden" readonly name="goods_desc[]" value="<?php echo $goods['goods_desc']; ?>">
                                                    <input type="hidden" readonly name="package_qty[]" value="<?php echo $data_measurement[$i]["package_qty"]; ?>">
                                                    <input type="hidden" readonly name="package_satuan[]" value="<?php echo $data_measurement[$i]["package_uom"]; ?>">
                                                    <input type="hidden" readonly name="gross_weight_non[]" value="<?php echo $data_measurement[$i]["gross_qty"]; ?>">
                                                    <input type="hidden" readonly name="gross_weight_non_satuan[]" value="<?php echo $data_measurement[$i]["gross_uom"]; ?>">
                                                    <input type="hidden" readonly name="measurement_qty[]" value="<?php echo $data_measurement[$i]["measurement_qty"]; ?>">
                                                    <input type="hidden" readonly name="measurement_satuan[]" value="<?php echo $data_measurement[$i]["measurement_uom"]; ?>">
                                            <?php
                                                    $i++;
                                                }
                                            }
                        ...
                        if (count($data_payment)  > 0) {  ?>
                            ...
                            <?php foreach ($data_payment as $payment) { ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">
                                        <input type="text" id="invoice_date" class="form-control" name="invoice_date[]" value="<?= date('d/m/Y', strtotime($payment["tgl_dok"])); ?>" readonly />
                                    </div>
