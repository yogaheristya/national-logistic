...
<table class="table table-stripped dt-responsive nowrap" id="request_sp2_ikt" cellspacing="0" width="100%">
...
<script>
  $(document).ready(function() {
    ...
    $(function() {
      var table = $("#request_sp2_ikt").DataTable({
        processing: true,
        serverSide: true,
        order: [],
        ajax: {
          url: site_url + '/C_cargo/getTableRequestSP2ikt/',
          method: "POST",
          data: function(data) {
            data.cargo = $('#selectcargo').val();
          }
        },
        columnDefs: [{
            className: "tglreqdo",
      ...
      $('#request_sp2_ikt tbody').on('click', 'td.details-release', function() {
    ...
    function format_request_sp2(callback, nobl, tglreq) {
      $.ajax({
        url: site_url + '/C_cargo/getDetailStatusSP2_NonContainer/' + nobl + '/' + tglreq,
        type: 'POST',
        dataType: "json",
