...
class M_cargo extends CI_Model {
    ...
    //                                 $sql = "INSERT INTO tblreqdo_buktibayar (id_reqdo_dok,kd_val,nilai,kd_bank,no_rekening,filepath_buktibayar) values ('".$id_dok."','".$kd_val[$i]."','".$nilaiUang."','".$kd_bank[$i]."','".$no_rekening[$i]."','".$path_buktibayar."')";
    ...
    //                         $date_dok = date('Y-m-d',strtotime($tgl_dok[$i]));
    //                         $sqldok = "INSERT INTO tblreqdo_dok (id_reqdo_header,jenis_dok,no_dok,tgl_dok,filepath_dok) values ('".$id_reqdo_header."','".$jenis_dok[$i]."','".$no_dok[$i]."','".$date_dok."','".$path_dok."')";
    //                         $execDok = $this->db->query($sqldok);
    //                         }
    ...
    public function getDataPdf($id) {
        ...
        $arrDataCon = $queryCon->result_array();        
         ...
         if ($_FILES['test_file']['name']!="") {
            ...
            if ($this->upload->do_upload('test_file')){
                ...
                if (!$response) {  
                    ...
                    file_put_contents( '../upload/meta/'.$file_name.'_copy', $response);
                } 
                curl_close($curl);
            }
            else{
