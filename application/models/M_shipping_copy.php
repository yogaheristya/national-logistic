    ...
    public function getDataRequest()
    {
        ...
        if ($search != "" && $param == '2') {
            ...
            if ($this->session->userdata('group') != '1201') {
                ...
                } elseif ($kd_shippingline == 'BBN') {
                    $sql = "SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_requestor) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('RCL','WHL')
                UNION SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_consignee) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('RCL','WHL')
                union select A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_notifyparty) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('RCL','WHL')";
                    // $this->db->where("(kd_shippingline='ASL' OR kd_shippingline='HSU' OR kd_shippingline='SWI' OR kd_shippingline='TSL' OR kd_shippingline='RCL')", NULL, FALSE);
                } elseif ($kd_shippingline == 'BEN') {
                    $sql = "SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_requestor) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('ECON','MCL','VMS','DEN','BOLT','TLS','UAFL','JOT','SUTTON','FESCO','FCC','SWI')
                UNION SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_consignee) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('ECON','MCL','VMS','DEN','BOLT','TLS','UAFL','JOT','SUTTON','FESCO','FCC','SWI')
                union select A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_notifyparty) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('ECON','MCL','VMS','DEN','BOLT','TLS','UAFL','JOT','SUTTON','FESCO','FCC','SWI')";
                    // $this->db->where("(kd_shippingline='ASL' OR kd_shippingline='HSU' OR kd_shippingline='SWI' OR kd_shippingline='TSL' OR kd_shippingline='RCL')", NULL, FALSE);
                } elseif ($kd_shippingline == 'MXC') {
                    $sql = "SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_requestor) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('MXC','CTP','XFP')
                UNION SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_consignee) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('MXC','CTP','XFP')
                union select A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_notifyparty) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('MXC','CTP','XFP')";
                    // $this->db->where("(kd_shippingline='ASL' OR kd_shippingline='HSU' OR kd_shippingline='SWI' OR kd_shippingline='TSL' OR kd_shippingline='RCL')", NULL, FALSE);
                } elseif ($kd_shippingline == 'KCA') {
                    $sql = "SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_requestor) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('VASCO','GOODRICH','SJA','SKS','DECCAN')
                UNION SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_consignee) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('VASCO','GOODRICH','SJA','SKS','DECCAN')
                union select A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_notifyparty) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('VASCO','GOODRICH','SJA','SKS','DECCAN')";
                    // $this->db->where("(kd_shippingline='ASL' OR kd_shippingline='HSU' OR kd_shippingline='SWI' OR kd_shippingline='TSL' OR kd_shippingline='RCL')", NULL, FALSE);
                } elseif ($kd_shippingline == 'SKN') {
                    $sql = "SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_requestor) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('STC','FCL','ASFL','WIN')
                UNION SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_consignee) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('STC','FCL','ASFL','WIN')
                union select A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_notifyparty) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('STC','FCL','ASFL','WIN')";
                    // $this->db->where("(kd_shippingline='ASL' OR kd_shippingline='HSU' OR kd_shippingline='SWI' OR kd_shippingline='TSL' OR kd_shippingline='RCL')", NULL, FALSE);
                } elseif ($kd_shippingline == 'SSI') {
                    $sql = "SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_requestor) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('BLK')
                UNION SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_consignee) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('BLK')
                union select A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_notifyparty) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('BLK')";
                    // $this->db->where("(kd_shippingline='ASL' OR kd_shippingline='HSU' OR kd_shippingline='SWI' OR kd_shippingline='TSL' OR kd_shippingline='RCL')", NULL, FALSE);
                } elseif ($kd_shippingline == 'LKN') {
                    $sql = "SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_requestor) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('DJD','HCL')
                UNION SELECT A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_consignee) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('DJD','HCL')
                union select A.*,B.* from tblreqdo_header A left join tbltab B on A.statusreqdo=B.kdnsw AND B.kdtab = 'D4' where lower(nama_notifyparty) like '%" . $search . "%' and statusreqdo in ('101','111','120','121') AND A.kd_shippingline in ('DJD','HCL')";
                    // $this->db->where("(kd_shippingline='ASL' OR kd_shippingline='HSU' OR kd_shippingline='SWI' OR kd_shippingline='TSL' OR kd_shippingline='RCL')", NULL, FALSE);
                } else {
            ...
            if ($this->session->userdata('group') != '1201') {
                if ($kd_shippingline == 'LSSC') {
                    ...
                    $this->db->where_in('kd_shippingline', array('RCL','WHL'));
                } elseif ($kd_shippingline == 'BEN') {
                    $this->db->where_in('kd_shippingline', array('ECON','MCL','VMS','DEN','BOLT','TLS','UAFL','JOT','SUTTON','FESCO','FCC','SWI'));
                } elseif ($kd_shippingline == 'MXC') {
                    $this->db->where_in('kd_shippingline', array('MXC','CTP','XFP'));
                } elseif ($kd_shippingline == 'SKN') {
                    $this->db->where_in('kd_shippingline', array('STC','FCL','ASFL','WIN'));
                }elseif ($kd_shippingline == 'SSI') {
                    $this->db->where_in('kd_shippingline', array('BLK'));
                } elseif ($kd_shippingline == 'LKN') {
                    $this->db->where_in('kd_shippingline', array('DJD','HCL'));
                } else {
        ...
        if ($nobl) {
            ...
            if (count($search_values) > 0) {
                foreach ($search_values as $row => $sv) {
                    ...
                    if ($row == 0) {
                        $q_explode = "nobl LIKE '%" . $sv . "%'";
                        // $q_explode = "nobl = '" . $parse . "'";
                    } else {
                        $q_explode = $q_explode . " OR nobl LIKE'%" . $sv . "%'";
                ...
                $this->db->where("nobl LIKE '%" . $nobl . "%'", NULL, FALSE);
