                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border">Request Details</legend>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="doreqexp" type="text"  class="form-control" value="<?= $data_header["tglexpreqdo"] ? date('Y-m-d',strtotime($data_header["tglexpreqdo"])) : '';?>" readonly>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="tglbl" type="text"  class="form-control" value="<?= $data_header["tglbl"] ? date('Y-m-d',strtotime($data_header["tglbl"])) : '';?>" readonly>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type=text name="tgldo"  class="form-control" id="tglrelease" value="<?=date('Y-m-d',strtotime($data_header['tgldoawal']))?>" readonly>
                                    </div>
                                    <label for="date" class="col-sm-1 col-form-label">DO Expired Date</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="tgldoakhir" id="tgldoakhir" class="form-control" value="<?=date('Y-m-d',strtotime($data_header['tgldoakhir']))?>" readonly>
                                    </div>
                                </div>
